...
{
    public sealed class SkipList64 : MemoryTable
    {
        ...
        private SearchResult Search(ReadOnlySpan<byte> key, out SkipListNode64 node)
        {
        ...
        public override IEnumerator<IMemoryItem> GetEnumerator() => new SkipListEnumerator64(_allocator);
