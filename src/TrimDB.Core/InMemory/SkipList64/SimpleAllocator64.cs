...
{
    public sealed class SimpleAllocator64 : SkipListAllocator64
    {
        ...
        public override SkipListNode64 HeadNode => GetNode(_headNodeLocation);
        ...
        public override SkipListNode64 GetNode(long nodeLocation)
        {
            ...
            return new SkipListNode64(memory, nodeLocation);
        }
